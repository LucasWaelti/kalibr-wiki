...
While many (parametric and non-parametric) methods have been proposed to (automatically) determine these the noise model parameters from samples, deriving the parameters form an Allan variance plot is probably the most common and standardized procedure.
