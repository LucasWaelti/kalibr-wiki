...
**Bias** In Kalibr, slow variations in the sensor bias are modelled with a "Brownian motion" process, also termed a "Wiener process", or "random walk" in discrete-time. Heuristically, this process is generated by integrating "white noise" of strength <img src="https://latex.codecogs.com/svg.latex?{%5Csigma_b_g}"> (gyro) or <img src="https://latex.codecogs.com/svg.latex?{%5Csigma_b_a}"> (accel):
